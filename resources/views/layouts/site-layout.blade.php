    ...
    <nav class="bg-white shadow border-gray-200 max-w-full overflow-hidden"> 
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="flex flex-row gap-[10px]">
          <a href="#booking-form-section" class="md:hidden navigation-item bg-fontSecondary !px-[20px] !py-[10px] !text-[black] rounded-lg" aria-current="page">Book an appointment</a>
