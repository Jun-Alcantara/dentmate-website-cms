...
<html>
  ...
  <body>
    ...
    <section class="bg-[#083d67]">
      <div class="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center py-5"> 
        <ul class="order-2 text-left">
          <li>
        ...
        <div class="order-1">
          <h3 class="uppercase text-white text-2xl text-left px-3">Explore More Smiles Here</h3>
          <div>
            <ul class="my-3 px-3 text-left">
            ...
            <ul class="text-white text-left px-3 my-3">
              <li>For urgent concerns, please call:</li>
              <li>09920446404</li>
              <li>09920446406</li>
              <li>09942046171</li>
              <li>09920446405</li>
              <li class="mt-3">Inquiries for calls are open from 8AM to 5PM only. Thank you!</li>
            </ul>
          </div>
        </div>
      </div>
